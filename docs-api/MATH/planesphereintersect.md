...
给出一个以tsphere_pos为中心、半径为asphere_radiusradius的三维球体，和一个通过三维点plane_pos的带有plane_normalnormal矢量的三维平面，如果有交点，返回1，如果没有，返回0。
...
交点通常是以intersect_pos为中心，以intersect_radiusradius为中心的相交平面上的一个二维圆。它也可以是一个单点，在这种情况下，交点半径被设置为0。
