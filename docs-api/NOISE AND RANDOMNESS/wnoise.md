...
`void  wnoise(float position, int &seed, float &f1, float &f2, float &f3,
float &f4)`
...
`void  wnoise(float position, int &seed, float &f1, float &f2, float &f4,
float &f4, int period)`
...
`void  wnoise(float posx, float posy, int &seed, float &f1, float &f2, float
&f3, float &f4)`
...
`void  wnoise(float posx, float posy, int &seed, float &f1, float &f2, int
periodx, int periody)`
...
`void  wnoise(vector2 position, int &seed, float &f1, float &f2, float &f3,
float &f4)`
...
`void  wnoise(vector2 position, int &seed, float &f1, float &f2, int periodx,
int periody)`
...
`void  wnoise(vector position, int &seed, float &f1, float &f2, float &f3,
float &f4)`
...
`void  wnoise(vector position, int &seed, float &f1, float &f2, int periodx,
...
`void  wnoise(vector4 position, int &seed, float &f1, float &f2, float &f3,
float &f4)`
...
`void  wnoise(vector4 position, int &seed, float &f1, float &f2, int periodx,
