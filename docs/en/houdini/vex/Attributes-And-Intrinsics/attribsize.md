...
a geometry prim attribute."), [pointattribsize](pointattribsize.html "## Returnsthe size of a geometry point attribute."), or
...
```c
// Get the size of the position attribute of "defgeo.bgeo" int size =
attribsize("defgeo.bgeo", "point", "P");
```
