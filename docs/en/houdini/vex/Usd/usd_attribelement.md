...
```c
// Get the value of an element at index 3 in the array attribute. float
a = usd_attribelement("opinput:0", "/geo/cube", "array_attrib_name", 3);  //
...
@b_element_2_at_frame_11 = usd_attribelement(0, "/geo/sphere", "bar", 2,
11.0);
```
