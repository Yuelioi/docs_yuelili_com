...
The primitive’s purpose for which to return the bounding box maximum (e.g.,
“render”).
...
```c
// Get the max of the first instance's boundsng box. vector max =
usd_pointinstance_getbbox_max(0, "/src/instanced_spheres", 0, "render");
