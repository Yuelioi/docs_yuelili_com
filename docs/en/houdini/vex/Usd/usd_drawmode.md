...
This function returns the given primitive’s draw mode, eg, “default”,
“origin”, “bounds”, etc.
...
```c
// Get the cube's draw mode, eg, "default", "bounds", etc. string
draw_mode = usd_drawmode(0, "/geo/cube");
```
