...
This function returns primitive’s axis-aligned bounding box of a particular
...
The primitive’s purpose for which to return the bounding box (e.g., “default”,
“render”).
...
```c
// Get the second sphere's bounding box. vector min, max;
usd_getpointinstancebounds(0, "/src/instanced_spheres", 1, "render", min,
max);
```
