...
Since this sets a vertex’s point, not a primitive’s vertex, it’s recommended
to use the equivalent function [setvertexpoint](setvertexpoint.html "Rewires a
vertex in the geometry to a different point.") for clarity, instead.
