...
以 modal 模式为例
    ...
        print(event.alt)  # 此时按住alt就会打印True
...
## mouse_prev_x #
    ...
    说明：窗口中鼠标的相对水平位置（与mouse_x不知道有啥不同。及时我缩放屏幕 还是一样的值。）




    类型：整型，[-inf, inf]。默认为0，只读
