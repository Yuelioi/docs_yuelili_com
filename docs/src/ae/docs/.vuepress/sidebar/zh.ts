...
export const zhSidebar = sidebar({
  ...
  "/zh/plugin-development/": [
    ...
    { text: "介绍", icon: "creative", prefix: "Introduction/", collapsable: true, children: "structure" },
    { text: "效果基础", icon: "creative", prefix: "Effect_Basics/", collapsable: true, children: "structure" },
