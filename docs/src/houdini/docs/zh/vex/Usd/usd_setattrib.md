...
usd\_setattrib(0, "/geo/sphere", "float\_attrib", 0.25);
usd\_setattrib(0, "/geo/sphere", "string\_attrib", "foo bar baz");
usd\_setattrib(0, "/geo/sphere", "vector\_attrib", {1.25, 1.50, 1.75});
