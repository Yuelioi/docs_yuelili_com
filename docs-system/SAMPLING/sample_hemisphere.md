...
to center.When supplied, `u.y` is simply replaced with `1-pow(1-u.y,
1.0/(bias+1.0))`.Toget a bias similar to this when using the more general
...
如果不指定，中心方向是（1,0,0），沿X轴。

`u`

Pair of numbers between 0 and 1.

对中心方向的偏置，在-1和无穷大之间，0是无偏置的。
...
0是无偏向的，-1强迫所有的点向地平线移动，而无穷大则强迫所有的点向中心移动。
