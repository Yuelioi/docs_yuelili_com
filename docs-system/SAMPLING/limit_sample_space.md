...
normal \(Gaussian\) distribution."), [sample_lognormal](sample_lognormal.html
...
的方式，在[0,1]中的均匀随机u将产生[minu,maxu]的均匀随机样本并返回。 这就避免了在范围边缘的额外样本
