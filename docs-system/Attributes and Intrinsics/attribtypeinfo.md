...
`string  attribtypeinfo(<geometry>geometry, string attribclass, string
attribute_name)`
...
geometry attribute."), or [vertexattribtypeinfo](vertexattribtypeinfo.html
"Returns the type info of a geometry attribute.") may be faster.
...
如果你提前知道了属性类，那么使用etailattribtypeinfo、primattribtypeinfo、pointattribtypeinfo或vertexattribtypeinfom可能会更快。
