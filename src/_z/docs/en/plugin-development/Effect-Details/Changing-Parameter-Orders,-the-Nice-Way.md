...
Create another enumeration for disk IDs. The order of this enumeration must _not_ be changed, though you may add to the end of this list. Note that the order of this list need not correspond with that of the parameter array index. Parameter disk IDs should range from 1 to 9999. Why not zero? Long story…
...
This is another prime use case for `PF_ParamFlag_USE_VALUE_FOR_OLD_PROJECTS` from [Parameter Flags](../effect-basics/PF_ParamDef.html) (#effect-basics-pf-paramdef-parameter-flags).
