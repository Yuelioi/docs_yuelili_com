...
vertex of the `hedge` in the primitive that contains `hedge` is wired. ## Returns`-1` if the half-edge is not valid.

## Examples ¶

```c
int presrcpt;  // Get the pre-source point of half-edge number 3.
