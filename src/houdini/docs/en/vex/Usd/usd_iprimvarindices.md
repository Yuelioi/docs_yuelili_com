...
the given primitive or inherited from primitive’s ancestor.
...
```c
// Get the index array of an indexed primvar. int indices[] =
usd_iprimvarindices(0, "/geo/cube", "indexed_primvar_name");
```
