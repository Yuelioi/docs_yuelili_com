...
the given primitive or inherited from primitive’s ancestor. E.g. “constant”,
“varying”, etc.
...
```c
// Get the interpolation style of the primvar on the cube or its
parent. string interpolation = usd_iprimvarinterpolation(0, "/geo/cube",
"primvar_name");
```
