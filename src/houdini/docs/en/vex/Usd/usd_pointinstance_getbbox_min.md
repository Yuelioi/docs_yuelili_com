...
The primitive’s purpose for which to return the bounding box minimum (e.g.,
“render”).
...
```c
// Get the min of the first instance's boundsng box. vector min =
usd_pointinstance_getbbox_min(0, "/src/instanced_spheres", 0, "render");
