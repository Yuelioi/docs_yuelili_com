...
This function returns primitive’s local transform. Transform order is a
...
```c
// Get the cube's transform order. string cube_xform_ops[] =
usd_transformorder(0, "/geo/cube");
```
