...
This function returns the names of the children authored directly in the
namespace of the given parent primitive.
...
```c
// Get the children of the "mother" primitive. string children[] =
usd_child(0, "/geo/mother");
```

## See also

- [usd_isprim](usd_isprim.html)
- [usd_attributenames()](usd_attributenames.html)
