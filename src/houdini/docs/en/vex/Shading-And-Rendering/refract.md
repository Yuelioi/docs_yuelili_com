...
Returns the refraction ray given an incoming direction, the normalized normal
and an index of refraction.

The index is a relative index of refraction, the ratio between the interior
...
In the case of total internal reflection, this function returns the reflection
vector.
