...
a geometry prim attribute."), [pointattribtype](pointattribtype.html "## Returnsthe type of a geometry point attribute."), or
...
```c
// Get the type of the position attribute of "defgeo.bgeo" int type =
attribtype("defgeo.bgeo", "point", "P");
```
