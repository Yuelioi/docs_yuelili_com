...
`<type> vertex(<geometry>geometry, string attribute\_name, int linear\_vertex\_index)`

`<type>[] vertex(<geometry>geometry, string attribute\_name, int linear\_vertex\_index)`

Specifies the vertex using the linear index into the list of all vertices.

`<type> vertex(<geometry>geometry, string attribute\_name, int prim\_num, int vertex\_num)`
