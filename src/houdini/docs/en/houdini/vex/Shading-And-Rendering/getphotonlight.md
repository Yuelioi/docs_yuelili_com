...
integer ID to the light name with [getlightname](getlightname.html "## Returnsthe name of the current light when called from within an illuminance loop, or
converts an integer light ID into the light’s name.")
