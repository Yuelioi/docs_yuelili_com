...
The primitive’s purpose for which to return the bounding box size (e.g.,
“render”).
...
```c
// Get the size of the first instance's boundsng box. vector size =
usd_pointinstance_getbbox_size(0, "/src/instanced_spheres", 0, "render");
