...
The primitive’s purpose for which to return the bounding box center (e.g.,
“render”).
...
```c
// Get the center of the first instance's boundsng box. vector center =
usd_pointinstance_getbbox_center(0, "/src/instanced_spheres", 0, "render");
