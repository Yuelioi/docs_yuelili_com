...
::: info Note
while this function takes the stage as an argument for consistency, it
...
```c
// Get the path of the primitive's parent, ie "/geo". string path =
usd_parentpath(0, "/geo/cube");
```
