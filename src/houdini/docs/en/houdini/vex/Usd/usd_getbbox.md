...
This function returns primitive’s axis-aligned bounding box. The point
...
```c
// Get the sphere's bounding box. vector min, max; usd_getbbox(0,
"/src/sphere", "render", min, max);
```
