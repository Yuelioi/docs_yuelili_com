...
`float [] resample\_linear(float input[], int new\_length)`

`vector [] resample\_linear(vector input[], int new\_length)`

`vector2 [] resample\_linear(vector2 input[], int new\_length)`
