...
`<type> usd\_iprimvar(<stage>stage, string primpath, string name)`

`<type>[] usd\_iprimvar(<stage>stage, string primpath, string name)`

`<type> usd\_iprimvar(<stage>stage, string primpath, string name, float timecode)`
...
vector vec\_value = usd\_iprimvar(0, "/geo/cube", "vec\_primvar\_name");
float values[] = usd\_iprimvar(0, "/geo/cube", "primvar\_name");
float value = usd\_iprimvar(0, "/geo/cube", "primvar\_name", 3);

v[]@foo\_at\_current\_frame = usd\_iprimvar(0, "/geo/sphere", "foo");
v[]@foo\_at\_frame\_8 = usd\_iprimvar(0, "/geo/sphere", "foo", 8.0);
