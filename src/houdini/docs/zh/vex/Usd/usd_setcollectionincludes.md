...
`int usd\_setcollectionincludes(int stagehandle, string collectionpath, string includes[])`
...
usd\_setcollectionincludes(0, collection\_path, array("/geo/sphere1", "/geo/sphere2"));
