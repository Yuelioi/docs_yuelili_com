...
usd\_setprimvar(0, "/geo/sphere", "float\_primvar", 0.25);
usd\_setprimvar(0, "/geo/sphere", "string\_primvar", "foo bar baz");
usd\_setprimvar(0, "/geo/sphere", "vector\_primvar", {1.25, 1.50, 1.75});
