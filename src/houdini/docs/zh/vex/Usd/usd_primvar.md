...
`<type> usd\_primvar(<stage>stage, string primpath, string name, float timecode)`
...
vector vec\_value = usd\_primvar(0, "/geo/cube", "vec\_primvar\_name");
float values[] = usd\_primvar(0, "/geo/cube", "primvar\_name");
float value = usd\_primvar(0, "/geo/cube", "primvar\_name", 3);

v[]@foo\_at\_current\_frame = usd\_primvar(0, "/geo/sphere", "foo");
