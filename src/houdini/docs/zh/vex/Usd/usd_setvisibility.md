...
::: info Note, these numeric codes are reflected as defines in the “usd.h” header file, as USD_VISIBILITY_INVISIBLE, USD_VISIBILITY_VISIBLE, and USD_VISIBILITY_INHERIT.
...
usd\_setvisibility(0, "/geo/sphere", USD\_VISIBILITY\_VISIBLE);
