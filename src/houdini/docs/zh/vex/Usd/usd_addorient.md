...
`int usd\_addorient(int stagehandle, string primpath, string suffix, vector4 orient)`
...
```c
// Orient the cube
vector4 quat = eulertoquaternion(radians({30,0,0}), XFORM\_XYZ);
usd\_addorient(0, "/dst/cone", "my\_orientation", quat);
