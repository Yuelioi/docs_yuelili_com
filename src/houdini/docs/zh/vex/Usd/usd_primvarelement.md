...
`<type> usd\_primvarelement(<stage>stage, string primpath, string name, int index)`

`<type> usd\_primvarelement(<stage>stage, string primpath, string name, int index, float timecode)`
...
float value = usd\_primvarelement(0, "/geo/cube", "primvar\_name", 3);

v@element\_2\_at\_current\_frame = usd\_primvarelement(0, "/geo/sphere", "foo", 2);
v@element\_2\_at\_frame\_8 = usd\_primvarelement(0, "/geo/sphere", "foo", 2, 8.0);
