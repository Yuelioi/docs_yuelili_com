...
`<type> usd\_flattenedprimvarelement(<stage>stage, string primpath, string name, int index, float timecode)`
...
float flat\_value = usd\_flattenedprimvarelement(0, "/geo/cube", "primvar\_name", 3);

f@flat\_primvar\_element\_10\_at\_current\_frame = usd\_flattenedprimvarelement(0, "/geo/sphere", "bar", 10);
