...
// Transform the cube.
#include <math.h>
matrix xform = maketransform(XFORM\_SRT, XFORM\_XYZ, {1,2,3}, {3,45,60}, {0.5,0.25,2});
usd\_addtransform(0, "/geo/cube", "my\_xform", xform);

```

```c
// Get the cube's world transform.
matrix xform = usd\_worldtransform(0, "/src/cube");
...
usd\_cleartransformorder(0, "/dst/cone");
usd\_settransformreset(0, "/dst/cone", 1);
