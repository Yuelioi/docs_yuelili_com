...
`int usd\_setprimvarelement(int stagehandle, string primpath, string name, int index, <type>value)`
...
usd\_setprimvarelement(0, "/geo/sphere", "float\_arr\_primvar", 2, 0.25);
