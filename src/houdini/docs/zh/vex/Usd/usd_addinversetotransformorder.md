...
string pivot\_xform\_suffix = "some\_pivot";
string pivot\_xform\_name = usd\_transformname(USD\_XFORM\_TRANSLATE, pivot\_xform\_suffix);

// Rotate about z-axis that goes thru pivot (1,0,0).
usd\_addtranslate(0, "/geo/cone", pivot\_xform\_suffix, {1, 0, 0});
usd\_addrotate(0, "/geo/cone", "some\_rotation", USD\_AXIS\_Z, -90);
